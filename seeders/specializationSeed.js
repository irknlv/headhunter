...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('SpecializationType', specializationTypesUpdated, {});

    await queryInterface.bulkInsert('Specialization', specializationsUpdated, {});
  },

  down: async (queryInterface, Sequelize) => {
    await queryInterface.bulkDelete('SpecializationType', null, {});
  },
};